...
ActiveRecord::Schema.define(version: 20161113200134) do
  ...
  add_index "loads", ["delivery_shift", "delivery_date", "truck_id"], name: "index_loads_on_delivery_shift_and_delivery_date_and_truck_id", unique: true, using: :btree
